...
const Soluciones = () => {
  return (
    <div className="bg-white">
      <div className="pt-6">
      <p className="text-3xl text-start tracking-tight text-gray-900">Composición del paquete básico Fisgon-Route</p>
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-bold tracking-tight text-start text-gray-900 sm:text-3xl">{product.name}</h1>
          </div>
